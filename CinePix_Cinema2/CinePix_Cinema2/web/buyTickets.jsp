    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col">
                    <div class="container-fluid">
                        <nav class="navbar navbar-expand-lg bg-body-tertiary p-md-3">
                            <div class="container">
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <a class="btn btn-outline-success" href="#" role="button">10:30 AM</a>
                                    </div>
                                    <div class="col">
                                        <a class="btn btn-outline-success" href="#" role="button">15:00 PM</a>
                                    </div>
                                    <div class="col">
                                        <a class="btn btn-outline-success" href="#" role="button">19:00 PM</a>
                                    </div>
