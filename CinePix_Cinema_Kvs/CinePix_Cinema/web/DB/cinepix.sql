...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2023 at 11:37 PM
...
INSERT INTO `movies` (`id`, `name`, `studio`, `image`, `duration`, `rating`, `storyLine`, `trailer`) VALUES
...
(3, '\r\nBLACK PANTHER: WAKANDA FOREVER', 'Marvel Studios', 'img/MVblackPanther.png', '2HR 41MIN ', '9/10', 'Black Panther: T\'Challa, heir to the hidden but advanced kingdom of Wakanda, must step forward to lead his people into a new future and must confront a challenger from his country\'s past.', 'https://www.youtube.com/embed/xjDjIWPwcPU'),
...
(5, 'STRANGE WORLD', 'Walt Disney Studios Motion Pictures', 'img/MVstrangeWorld.jpg', '1HR 42MIN', '7/10', 'Strange World: The legendary Clades are a family of explorers whose differences threaten to topple their latest and most crucial mission.', 'https://www.youtube.com/embed/bKh2G73gCCs'),
(6, 'VIOLENT NIGHT', 'Universal Pictures', 'img/MVviolentNight.jpg', '1HR 52MIN ', '9/10', 'Violent Night: When a group of mercenaries attack the estate of a wealthy family, Santa Claus must step in to save the day (and Christmas).', 'https://www.youtube.com/embed/a53e4HHnx_s'),
...
(9, '\r\nMINIONS:THE RISE OF GRU', 'Universal Pictures', 'img/MVminions.jpg', '1HR 30MIN', '9/10', 'Minions:The untold story of one twelve-year-old\'s dream to become the world\'s greatest supervillain.         ', 'https://www.youtube.com/embed/6DxjJzmYsXo'),
